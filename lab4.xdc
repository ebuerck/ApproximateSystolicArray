...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { Ga }]; 
IO_L18P_T2_A24_15 Sch=Ga
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { Ya }]; 
IO_L24P_T3_RS1_15 Sch=Ya
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { Ra }]; 
IO_L17N_T2_A25_15 Sch=Ra
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { WALK }]; 
IO_L8P_T1_D11_14 Sch=WALK
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { NOWALK }]; 
IO_L7P_T1_D09_14 Sch=NOWALK
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { LLED }]; 
IO_L18N_T2_A11_D27_14 Sch=LLED
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports {Sb}]; 
IO_L12P_T1_MRCC_14 Sch=Sb
